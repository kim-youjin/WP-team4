...
import "../ClassList/topclassslide.css";
    ...
    <div className="container">
        <Slider {...settings} style={{margin: 30}}>
          ...
          <a href={`/lectures/${lec03}`}>
            <div>
            <img src={Lecture10} alt="" width="300px"/>
            <h3>강의3</h3>
          </div>
          </a>
          ...
          <a href={`/lectures/${lec04}`}>
            <div>
            <img src={Lecture4} alt="" width="300px"/>
            <h3>강의4</h3>
          </div>
          </a>
          ...
          <a href={`/lectures/${lec06}`}>
            <div>
            <img src={Lecture6} alt="" width="300px"/>
            <h3>강의6</h3>
          </div>
          </a>
          ...
          <div>
            <img src={Lecture9} alt="" width="300px"/>
            <h3>강의9</h3>
          </div>
          </a>
